...
public interface IDocumentSpecVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitBoldText([NotNull] DocumentSpecParser.BoldTextContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitItalicText([NotNull] DocumentSpecParser.ItalicTextContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitUnderlineText([NotNull] DocumentSpecParser.UnderlineTextContext context);
